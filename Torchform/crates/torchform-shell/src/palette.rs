...
fn default_commands() -> Vec<PaletteEntry> {
    vec![
        ...
        PaletteEntry {
            id:          "app.camera".into(),
            label:       "Camera".into(),
            description: "Capture photos and video".into(),
            category:    "App".into(),
            icon:        "📷".into(),
            shortcut:    "".into(),
        },
        PaletteEntry {
            id:          "app.media".into(),
            label:       "Media Player".into(),
            description: "Play audio and video files".into(),
            category:    "App".into(),
            icon:        "🎵".into(),
            shortcut:    "".into(),
        },
        PaletteEntry {
            id:          "app.keyboard".into(),
            label:       "On-Screen Keyboard".into(),
            description: "Virtual keyboard for the lower display".into(),
            category:    "App".into(),
            icon:        "⌨".into(),
            shortcut:    "".into(),
        },
